...
CEPH_NODE_HOSTIP=(192.168.100.180 192.168.100.181 192.168.100.182 192.168.100.183)
...
# ssh-copy-id ubuntu@plana003.test.com
# ssh-copy-id ubuntu@plana004.test.com
# ssh-copy-id ubuntu@plana005.test.com
# ssh-copy-id ubuntu@plana006.test.com
...
# cd src/teuthology_master/
# source virtualenv/bin/activate
# teuthology-lock --owner initial@setup --unlock plana003.test.com
# teuthology-lock --owner initial@setup --unlock plana004.test.com
